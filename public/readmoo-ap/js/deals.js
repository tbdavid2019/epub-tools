    ...
    return '<article class="' + cls + '">' +
      ...
      '<div class="deal-cell-actions">' +
        ...
        '<a href="' + esc(deal.bookUrl) + '" class="deal-cell-link" target="_blank" rel="noopener">' +
          '官網購買 <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="14" height="14"><line x1="5" y1="12" x2="19" y2="12"/><polyline points="12 5 19 12 12 19"/></svg>' +
        '</a>' +
      '</div>' +
    '</article>';
  }
